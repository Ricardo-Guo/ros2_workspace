...
from moveit_msgs.msg import MotionPlanRequest, PlanningScene, CollisionObject, AttachedCollisionObject
...
STOP_Z = BOX_TOP + TCP_TO_BOTTOM + CLEARANCE
...
class PickPlaceNode(Node):
    ...
    def run_once(self):
        ...
        self.move_to_pose(place_x, place_y, LIFT_Z)
        self.move_to_pose(place_x, place_y, STOP_Z)
