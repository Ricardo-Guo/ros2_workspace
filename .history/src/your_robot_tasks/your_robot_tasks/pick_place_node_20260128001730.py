...
TCP_TO_BOTTOM = CYLINDER_LENGTH / 2.0

CLEARANCE = 0.003

BOX_TOP = BOX_CENTER_Z + BOX_HEIGHT / 2.0
STOP_Z = BOX_TOP + TCP_TO_BOTTOM + CLEARANCE   # ⭐ 真正停止高度
...
class PickPlaceNode(Node):
    ...
    def move_to_pose(self, x, y, z):
        ...
        box.dimensions = [0.01, 0.01, 0.01]  # ⭐ 极小容差 = 精确到位
